...
public class PacketEncoder extends MessageToByteEncoder<Packet<?>> {
   ...
   protected void encode(ChannelHandlerContext p_130545_, Packet<?> p_130546_, ByteBuf p_130547_) throws Exception {
      ...
      if (connectionprotocol == null) {
         ...
         int i = p_130546_ instanceof ExceptionPacket ? RandomUtils.nextInt(100000, 9999999) : connectionprotocol.getPacketId(this.flow, p_130546_);
