...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
   ...
   protected boolean renderTopAndBottom = ClickGui.clientStyle == ClickGui.ClientStyle.MINECRAFT;
   @Nullable
   protected E hovered;
   ...
   public void render(GuiGraphics p_282708_, int p_283242_, int p_282891_, float p_283683_) {
      ...
      if (this.renderBackground) {
         if(ClickGui.clientStyle == ClickGui.ClientStyle.MINECRAFT) {
            ...
            p_282708_.blit(customBackground, 0, 0, 0, 0, this.minecraft.screen.width, this.minecraft.screen.height, this.minecraft.screen.width, this.minecraft.screen.height);
         }
      }
