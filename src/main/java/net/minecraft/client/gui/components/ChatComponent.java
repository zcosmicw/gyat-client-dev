...
import us.gyatdevs.exploits.impl.PluginExploit;
...
public class ChatComponent {
   ...
   private final List<String> ignoredPhrases = List.of(
           "Can't deliver chat message, check server logs: "
   );
   ...
   private void addMessage(Component p_240562_, @Nullable MessageSignature p_241566_, int p_240583_, @Nullable GuiMessageTag p_240624_, boolean p_240558_) {
      ...
      if(!isContainsIgnoredPhrase(p_240562_.getString())) {
...
//         }
   ...
   private boolean isContainsIgnoredPhrase(String phrase){
      for (String ignored : ignoredPhrases){
         if(phrase.contains(ignored)) return true;
      }
      return false;
   }
