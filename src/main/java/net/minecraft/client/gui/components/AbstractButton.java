...
public abstract class AbstractButton extends AbstractWidget {
   ...
   protected void renderWidget(GuiGraphics p_281670_, int p_282682_, int p_281714_, float p_282542_) {
      ...
      if(ClickGui.clientStyle == ClickGui.ClientStyle.MINECRAFT){
         ...
         int cornerRadius = 10;
         int backgroundColor = this.isHovered() ? new Color(0, 0, 0, 190).getRGB() : new Color(0, 0, 0, 150).getRGB();
         p_281670_.fillRounded(this.getX(), this.getY(), this.getWidth(), this.getHeight(), cornerRadius, backgroundColor);
         ...
         p_281670_.drawString(font, text, textX, textY, textColor);
