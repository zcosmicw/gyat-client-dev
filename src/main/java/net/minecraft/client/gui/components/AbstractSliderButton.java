...
public abstract class AbstractSliderButton extends AbstractWidget {
   ...
   public void renderWidget(GuiGraphics p_283427_, int p_281447_, int p_282852_, float p_282409_) {
      ...
      if(ClickGui.clientStyle == ClickGui.ClientStyle.MINECRAFT) {
         ...
         int cornerRadius = 10;
         p_283427_.fillRounded(this.getX(), this.getY(), this.getWidth(), this.getHeight(), cornerRadius, new Color(0, 0, 0, 150).getRGB());
         p_283427_.fillRounded(this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 8, 20, 5, new Color(42, 42, 42).getRGB());
      }
